   ...
   <div class="container-fluid">
    ...
    <center>
     <table>
		...
		<tr>
		   <td>8:45-9:40</td>
		   <td colspan="2"> HMM305 <br/> <sub><pre>310 BLOCK-1            SN</pre></sub> </td>
		   <td colspan="2">   </td>
		   <td>CMP002</td>
		   <td>CSE331</td>
		   <td rowspan="2"> INT353 <br/></td>
		   <td>CSE202</td>
		   <td colspan="2"> CSE202 <br/> <sub><pre>310 BLOCK-1            AU</pre></sub> </td>
		</tr>
		...
		<tr>
		   ...
		   <td colspan="2"> CSE202 <br/> <sub><pre>310 BLOCK-1            AU</pre></sub> </td>
		   <td colspan="2">   </td>
		   <td colspan="2"> CSE320 <br/> <sub><pre>310 BLOCK-1           KKR</pre></sub> </td>
		   <td> CSE310 </td>
		   <td>CMP002</td>
		   <td>CSE331</td>
		</tr>
		...
		<tr>
		   ...
		   <td colspan="2"> CSE320 <br/> <sub><pre>310 BLOCK-1           KKR</pre></sub> </td>
		   <td colspan="2">   </td>
		   <td colspan="2"> INT303 <br/> <sub><pre>310 BLOCK-1            SG</pre></sub> </td>
		   <td>CSE320</td>
		...
		<tr>
		   ...
		   <td>CSE331</td>
		   <td colspan="2"> CSE202 <br/> <sub><pre>310 BLOCK-1            AU</pre></sub> </td>
		   <td colspan="2"> INT320 <br/> <sub><pre>310 BLOCK-1            AM</pre></sub> </td>
		   <td>CSP381</td>
		...
		<tr>
		   ...
		   <td colspan="2">LUNCH <br/> <sub><pre>         LUNCH           </pre></sub> </td>
		   <td colspan="2">LUNCH <br/> <sub><pre>         LUNCH           </pre></sub> </td>
		   <td colspan="2">INT303 <br/> <sub><pre>310 BLOCK-1            SN</pre></sub></td>
		</tr>
		...
		<tr>
		   ...
		   <td>CMP002</td>
		   <td>CSE331</td>
		   <td colspan="2"> CSE310 <br/> <sub><pre>310 BLOCK-1            GA</pre></sub> </td>
		</tr>
